...
register_all_protocols(register_cb cb, gpointer client_data)
{
    ...
    {extern void proto_register_etcd_protocol (void); if(cb) (*cb)(RA_REGISTER, "proto_register_etcd_protocol", client_data); proto_register_etcd_protocol ();}
...
register_all_protocol_handoffs(register_cb cb, gpointer client_data)
{
    ...
    {extern void proto_reg_handoff_etcd_protocol (void); if(cb) (*cb)(RA_HANDOFF, "proto_reg_handoff_etcd_protocol", client_data); proto_reg_handoff_etcd_protocol ();}
